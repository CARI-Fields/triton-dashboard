...
function isDataSpec(value: unknown): value is Experiment["data_spec"] {
...
function isObjectSpec(value: unknown): value is Experiment["object_spec"] {
  return isRecord(value)
...
function isConfig(value: unknown): value is Experiment["config"] {
...
function isMetrics(value: unknown): value is Experiment["metrics"] {
